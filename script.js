...
function generatePassword() {
  ...
  for (var i = 0; i < 7; i++) {                       // for loop for 4 char and 4 num
  ...
  for (var i = 1; i < randomCharArr.length; i++) {
    final += alphabet[randomCharArr[i]];
  }
  final += char + randomNumArr[0] + randomNumArr[1] + randomNumArr[2] + randomNumArr[3];
...
$("button").on("click", function () {          //eventlistner for button click
  ...
  document.getElementById("passwordinput").style.borderColor="#0aef69de";
